...
public class Camera2 {
    ...
    Camera2(MainActivity mainActivity_) {
        ...
        textureView = mainActivity.videoTexture;
...
//            cameraId = manager.getCameraIdList()[0];
    ...
    private final CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice camera) {
            ...
            cameraDevice = camera;
            createCameraPreview();
            setTextureTransform(cameraCharacteristicsHashMap.get(cameraId));
        }
...
//        rack.videoTexture.getSurfaceTexture().setDefaultBufferSize(width, height);
        ...
        RectF viewRect = new RectF(0,0, mainActivity.videoTexture.getWidth(), mainActivity.videoTexture.getHeight());
        ...
        mainActivity.videoTexture.setTransform(matrix);
    }
    ...
    int getDisplayRotation() {
        switch (mainActivity.videoTexture.getDisplay().getRotation()) {
